...
const hasCEndSign = function(req){
    return req.query && (req.query.tracePage === 'liveCenter' || /tweet|tab/.test(req.query.wcl) || req.query.pushSource === 'qlLive');
};

module.exports.getUrlParams = getUrlParams;
module.exports.fillParams = fillParams;
module.exports.hasCEndSign = hasCEndSign;